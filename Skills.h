...
/* If you're running this on MVS, __DO NOT__ put it in the LPA because this compiles down to a module that is too darn big to fit! */
/* Also if you're on MS-DOS or a non-VM capable UNIX (ex. PDP-11), you might need to cut out some other files. */
...
int listNumSkills3 = 144;
int listNumSkills4 = 197;


char* fileHeader = {
	"###\n### Skill Randomizer\n### https://github.com/HackerSmacker/BL3GenRandomizer\n### Generated by mkskillrand\n"
};
